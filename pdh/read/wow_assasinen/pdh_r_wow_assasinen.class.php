...
/*+----------------------------------------------------------------------------
  | pdh_r_wow_assasinen
  +--------------------------------------------------------------------------*/
if (!class_exists('pdh_r_wow_assasinen')) {
	class pdh_r_wow_assasinen extends pdh_r_generic {
		...
		*/
		...
		public function get_profilers($member_id){
			...
			$a_profilers	= array(
				1	=> array(
					'icon'	=> $this->server_path.'games/wow_assasinen/profiles/profilers/askmrrobot.png',
					'name'	=> 'AskMrRobot.com',
